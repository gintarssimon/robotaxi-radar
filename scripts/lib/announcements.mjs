...
const HOSTS={Waymo:['waymo.com','www.waymo.com'],Uber:['uber.com','www.uber.com','investor.uber.com'],Lyft:['lyft.com','www.lyft.com','investor.lyft.com'],Tesla:['tesla.com','www.tesla.com']};
...
function operatorFor(provider,context){
...
export function parseAnnouncements(provider,page,cities,today){
  ...
  if(!page.isArticle||page.dynamic||!HOSTS[provider]?.includes(new URL(page.url).hostname))return {records,issues};
